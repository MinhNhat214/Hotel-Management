...
@section('content')
    ...
    @endif
    <form class="container mx-auto px-60 pb-10" method="post" action="{{ route('admin.booking_edit_submit') }}">
        @method('PUT')
        @csrf
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <input type="number" id="user_id" name="user_id" class="input" value="{{ $booking->user_id }}"
                    required />
            </div>
            <div>
