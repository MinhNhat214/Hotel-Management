        ...
        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            ...
            <div>
                ...
                <ul class="text-gray-500 font-medium">
                    ...
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Câu hỏi thường gặp</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-gray-500 font-medium">
                    ...
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Quy định chung</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Quy định về thanh toán</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Chính sách giải quyết quyền riêng tư</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-gray-500 font-medium">
                    ...
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Cẩm nang du lịch</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Thành tựu</a>
                    </li>
                </ul>
            </div>
        </div>
